...
resource "aws_instance" "gateway_easy_find" {
  ...
  provisioner "file" {
    source      = "./gatewayconfig/gatewayconfig.sh"  # Caminho local do seu script
    ...
    provisioner "file" {
    source      = "./backconfig/apiconfig.sh"  # Caminho local do seu script
  ...
  provisioner "file" {
    source      = "./frontconfig/frontconfig.sh"  # Caminho local do seu script
    destination = "/home/ubuntu/frontconfig.sh"   
  ...
  provisioner "file" {
    ...
    destination = "/home/ubuntu/bdconfig.sh"   
